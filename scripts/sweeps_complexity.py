...
def main():
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.5,
        help="Memory window passed to the 4D Hawkes simulation path (mode=full). Paper default: 0.5.",
    )
    parser.add_argument(
        "--field-name-bg",
        type=str,
        default="moving_gauss_slow",
        help="Heterogeneity background field name for mode=full. Paper default: moving_gauss_slow.",
    )
    parser.add_argument(
        "--ent-option",
        type=str,
        default="rt",
        help="Entangled kernel shape option for mode=full. Paper default: rt.",
    )
    parser.add_argument(
        "--seed-offset",
        type=int,
        default=1234,
        help="Base seed offset for mode=full; replicate id is added to this value. Paper default: 1234.",
    )
    ...
    if args.mode == "full":
        run_complexity_sweep_4d(
            ...
            field_name_bg=args.field_name_bg,
            ent_option=args.ent_option,
