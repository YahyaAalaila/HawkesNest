...
def thinning(background, kernel, time_horizon: float, domain: list, adjacency: np.array, Lambda: float, n_acc: int, rng=None):
    """
    ...
    if time_horizon is None:
        raise ValueError("time_horizon or n_acc must be specified to control simulation duration.")
